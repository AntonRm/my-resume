...
const requestReceivModal = document.querySelector('#request-received');
...
callbackForm.addEventListener('submit', function(event) {
    ...
    requestReceivModal.classList.add('modal-active');

    setTimeout(function() {
        requestReceivModal.classList.remove('modal-active');
    }, 2000);
});
